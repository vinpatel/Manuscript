// Package handler implements HTTP request handlers for the Manuscript API.
//
...
// This is the main endpoint of the Manuscript API.
//
...
func (h *Handler) Index(w http.ResponseWriter, r *http.Request) {
	...
	response := map[string]any{
		...
		"documentation": "https://github.com/manuscript/manuscript",
	}
