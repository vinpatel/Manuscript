...
# ==============================================================================
#
# This Makefile provides commands for building, testing, and deploying Manuscript.
#
# Usage:
...
help: ## Show this help message
	@echo "$(BLUE)Manuscript - Verify human-created content$(NC)"
	@echo ""
...
run: ## Run the API locally
	@echo "$(BLUE)Starting Manuscript API...$(NC)"
...
docs: ## Generate documentation
	...
	@echo "Open http://localhost:6060/pkg/github.com/manuscript/manuscript/"
	godoc -http=:6060
...
api-bench: ## Benchmark API (requires hey: go install github.com/rakyll/hey@latest)
	...
	hey -n 1000 -c 50 -m POST \
		-H "Content-Type: application/json" \
		-d '{"text": "This is a benchmark test for the Manuscript API."}' \
