// Package main is the entry point for the Manuscript API server.
//
// Manuscript is a simple API that verifies whether content (text, image, audio, video)
...
import (
	...
	"github.com/manuscript/manuscript/internal/config"
	"github.com/manuscript/manuscript/internal/handler"
	"github.com/manuscript/manuscript/internal/middleware"
...
func main() {
	...
	log.Info("starting manuscript api",
		"version", version,
...
func buildServer(cfg *config.Config, app *App, log *logger.Logger) *http.Server {
	...
	// Main API endpoint - the core of Manuscript
