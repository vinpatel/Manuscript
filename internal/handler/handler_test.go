...
import (
	...
	"github.com/manuscript/manuscript/internal/repository"
	"github.com/manuscript/manuscript/internal/service"
...
func TestIndex(t *testing.T) {
	...
	if response["name"] != "Manuscript API" {
		t.Errorf("expected name 'Manuscript API', got %v", response["name"])
	}
}
