# ==============================================================================
# Manuscript API Dockerfile
# ==============================================================================
#
# Multi-stage build for minimal production image.
#
# Build:
#   docker build -t manuscript/api .
#
# Run:
#   docker run -p 8080:8080 manuscript/api
#
# ==============================================================================
...
LABEL org.opencontainers.image.title="Manuscript API"
LABEL org.opencontainers.image.description="Verify human-created content"
LABEL org.opencontainers.image.source="https://github.com/manuscript/manuscript"
LABEL org.opencontainers.image.vendor="Manuscript"
...
RUN addgroup -g 1000 manuscript && \
    adduser -u 1000 -G manuscript -s /bin/sh -D manuscript

# Set working directory
WORKDIR /app

# Copy binary from builder
COPY --from=builder /build/manuscript .

# Copy any static files if needed
# COPY --from=builder /build/static ./static

# Change ownership to non-root user
RUN chown -R manuscript:manuscript /app
